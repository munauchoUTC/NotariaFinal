		        ...
		        <div  style="margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
		                    <div class="panel panel-info" style="background: rgba(255, 255, 255, .9);">
		                        <div class="panel-heading">
		                            <div class="panel-title"><b><center>INGRESE SUS DATOS PARA INICIAR SECCIÓN</center></b>   
		                        ...
		                        <div class="panel-body" >
		                                ...
		                                <div class="form-group" style="margin-bottom: 25px">
		                                    ...
		                                    <div class="col-md-9">
		                                        <input type="password" id="password" class="form-control" name="contrasena" placeholder="Ingrese su contraseña" required/>
		                                    </div>
		                                </div>
		                                <br>
		                       ...
		                       <div class="form-group" style="margin-bottom: 25px">
		                                    ...
		                                    <div class="col-md-9">
												...
												<p class="error" style="color: blue; font-weight: bold;">
												<a href="recuperarcon.php">¿Olvido su contraseña?</a>
												</p>
		                                ...
		                                <div class="form-group" style="margin-bottom: 25px">
		                                    ...
		                                    <div class="col-md-offset-3 col-md-9">
		                                        <button id="btn-signup" type="submit" class="btn btn-primary" ><b>	Ingresar al Sistema</b></button>
		                                    </div>
