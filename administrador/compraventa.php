...
?>
    ...
    <header>        
        ...
        <!-- Titulo -->
        <div id="titulo">
            <h1>Usuarios con sus Respectivas Escrituras de CompraVenta</h1>
        </div>
...
<center>
        ...
        $db=new Conect_MySql();
            $sql = "select*from cliente where tipo_escritura_cli='CompraVenta'";
            $query = $db->execute($sql);
            while($datos=$db->fetch_row($query)){?>
            <tr>
                <td><?php echo $datos['cedula_cli']; ?></td>
                <td><?php echo $datos['nombre_cli']; ?></td>
                <td><?php echo $datos['genero_cli']; ?></td>
                <td><?php echo $datos['direccion_cli']; ?></td>
                <td><?php echo $datos['estado_civil_cli']; ?></td>
